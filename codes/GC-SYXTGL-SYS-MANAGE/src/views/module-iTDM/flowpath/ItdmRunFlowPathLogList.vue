<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="流程id">
              <j-search-select-tag placeholder="请选择流程id" v-model="queryParam.runFlowPath" dict="itdm_run_flow_path,weituo_no,id"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('运行流程步骤日志')">导出</a-button>
    ...
    <itdm-run-flow-path-log-modal ref="modalForm" @ok="modalFormOk"></itdm-run-flow-path-log-modal>
  </a-card>
</template>
...
<script>
  ...
  import ItdmRunFlowPathLogModal from './modules/ItdmRunFlowPathLogModal'

  export default {
    name: 'ItdmRunFlowPathLogList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      ItdmRunFlowPathLogModal
    },
    data () {
      return {
        description: '运行流程步骤日志管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/flowpath/itdmRunFlowPathLog/list",
          delete: "/flowpath/itdmRunFlowPathLog/delete",
          deleteBatch: "/flowpath/itdmRunFlowPathLog/deleteBatch",
          exportXlsUrl: "/flowpath/itdmRunFlowPathLog/exportXls",
          importExcelUrl: "flowpath/itdmRunFlowPathLog/importExcel",
